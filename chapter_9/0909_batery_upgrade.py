...
#Update the electric car class from eariler. Add a method called upgrade_battery()
class Car:
...
#Make an electric car with a default battery size, call the following functions:
my_porsche = ElectricCar('porsche', 'tycan', 2021)
print(my_tporsche.get_descriptive_name())
my_porsche.get_range()
my_porsche.upgrade_battery()
my_porsche.get_range()
